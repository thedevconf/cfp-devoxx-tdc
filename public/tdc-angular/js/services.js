...
remoteServices.factory('ApprovedTalksService', ['$resource', function($resource) {
   return $resource('/cfpadmin/scheduling/approvedTalks', null, {'query': {method: 'GET', isArray: true, responseType:'json'}});
}]);


/*remoteServices.factory('SlotService', ['$resource', function($resource) {
   return $resource('/cfpadmin/scheduling/slots', null, {'query': {method: 'GET', isArray: true, responseType:'json'}});
}]);*/
